            ...
            <div className='my-10 flex flex-col md:flex-row gap-12'>
                ...
                <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
                    <p>Welcome To MediCare, Your Trusted Partner In Managing Your HealthCare Needs Conveniently And Efficiently.
                        At MediCare, We Understand The Challenges Individuals Face When It Comes To Scheduling Doctor Appointments And Managing Their Health Records.
                    </p>
                    <p>MediCare Is Commited To Excellence In Healthcare Technology.
                        ...
                        Whether You're Booking Your First Appointment Or Managing Ongoing Care, MediCare Is Here To Support You Every Step Of The Way.
                    </p>
                    <b className='text-gray-800'>Our Vision</b>
                    <p>Our Vision At MediCare Is To Create A Seamless HealthCare Experience For Every User.
