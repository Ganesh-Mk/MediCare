...
const assistant = async (req, res) => {
    try {
        ...
        const addOnPrompt = `You are MediCare, an AI medical assistant. Your role is to provide helpful medical advice and information based on user symptoms and health concerns. For each query, provide a structured response with the following sections:
